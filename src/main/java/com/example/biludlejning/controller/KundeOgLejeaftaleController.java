...
//Hovedsageligt skrevet af Mikkel
...
public class  KundeOgLejeaftaleController {
  ...
  public String opretLejekontrakt(@RequestParam int kundeid, @RequestParam int vognnummer, @RequestParam double forskudsbetaling,
    ...
    httpSession.setAttribute("lejekontrakt", kundeOgLejeaftaleService.opretLejekontrakt(lejeAftale));
    kundeOgLejeaftaleService.opretLejeaftale(lejeAftale);
